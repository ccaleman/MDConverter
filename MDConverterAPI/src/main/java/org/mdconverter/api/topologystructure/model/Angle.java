 ...
 */
public class Angle extends ValueGS implements FuncType {
    ...
    public Angle(String ai, String aj, String ak, Integer funcType, BigDecimal c1, BigDecimal c2) {
        this.ai = ai;
        this.aj = aj;
        this.ak = ak;
    ...
    public Angle(String ai, String aj, String ak, Integer funcType, BigDecimal c1, BigDecimal c2, BigDecimal c3) {
        this.ai = ai;
        this.aj = aj;
        this.ak = ak;
        this.funcType = funcType;
