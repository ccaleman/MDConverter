...
public class FileWriter {
    ...
    /**
     * @param ff        if ForceField data should be included or not
     * @param structure the structure generated by the ReaderPlugin and converted by the unitConverter
     * @return the {@link TopologyStructure} in Gromacs file format top
     */
